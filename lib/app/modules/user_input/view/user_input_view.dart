import 'package:project/widget/Container_Widget.dart';
import 'package:project/widget/ElevatedButton_Widget.dart';
import 'package:project/widget/KAppBar.dart';
...
class UserInputView extends GetView<UserInputController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const KAppBar(title: "Insert Github"),
      body: Center(
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: KeleButtonText(
                      ...
                      backgroundColor:
                          istheme.theme.value ? Colors.black : Colors.blue,
                    ),
                  ),
                ],
              ),
